package com.capgemini.junit.testing_file_handling_methods;
...
class FileHandlingMethodsTest {
    ...
    void testWriteToFileAndReadFromFile() throws IOException {
        FileHandlingMethods.writeToFile(TEST_FILE, TEST_CONTENT);
        String content = FileHandlingMethods.readFromFile(TEST_FILE);
    ...
    void testFileExistsAfterWriting() throws IOException {
        FileHandlingMethods.writeToFile(TEST_FILE, TEST_CONTENT);
        assertTrue(FileHandlingMethods.fileExists(TEST_FILE));
    }

    @Test
    void testReadFromFileThrowsIOExceptionForMissingFile() {
        assertThrows(IOException.class, () -> FileHandlingMethods.readFromFile("nonexistent.txt"));
    }
